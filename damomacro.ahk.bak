...
AHI.Instance.SendKeyEvent(HID, GetKeySC("g"), 1)
AHI.Instance.SendKeyEvent(HID, GetKeySC("g"), 0)
sleep 100
suddenraid := false
SetTimer, suddenraid, -15000
}
...
loop 4 {
random, ran, 80,120
AHI.Instance.SendKeyEvent(HID, GetKeySC("9"), 1)
sleep %ran%
AHI.Instance.SendKeyEvent(HID, GetKeySC("9"), 0)
}
sleep 500
SetTimer, darkflare, -60000
darkflare := false
}
ImageSearch,vX,vY,1,1,1920,1080, *1 me.png
